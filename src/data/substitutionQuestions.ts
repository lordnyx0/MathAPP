export interface SubstitutionChunk {
    ...
    isSelectable: boolean; // some parts like '\int', 'dx', '\frac{' might not be selectable as u
}
...
export const substitutionQuestions: SubstitutionQuestion[] = [
    ...
    },
    {
        ...
        explanation: 'Escolhemos u = x^2 porque a derivada (2x) cancela o termo multiplicando a exponencial.',
    },
    {
        id: 's3',
        ...
        explanation: 'Escolhemos u = \ln(x) porque a derivada (1/x) cancela perfeitamente o x do denominador.',
    },
    {
        id: 's4',
        ...
        correctUText: 'x^3 + 1',
        duText: '3x^2 dx',
        remainingAfterDu: '\\int \\frac{1}{3} \\sqrt{u} du',
        finalUIntegral: '\\frac{1}{3} \\int u^{1/2} du',
        explanation: 'Escolhemos u = x^3 + 1. O du = 3x^2 dx. Embora não seja exato (falta o 3), o x^2 resolve o x^2 da função original.',
    }
];
